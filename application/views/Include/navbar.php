<?php
  ...
  $company_info = $this->User_Model->get_info_arr_fields('company_name','company_id', $lodge_company_id, 'company');
  $user_info = $this->User_Model->get_info_arr_fields('user_name','user_id', $lodge_user_id, 'user');
?>
      ...
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item has-treeview">
          ...
          <ul class="nav nav-treeview" style="display: none;">
            ...
            <li class="nav-item">
              <a href="<?php echo base_url(); ?>User/room_list" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>Room</p>
              </a>
            </li>
